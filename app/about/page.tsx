...
export const metadata: Metadata = generatePageMetadata({
  title: "About",
  description: "Learn more about Tekenatei Franklyn — Product Manager, Engineer, and Cybersecurity Specialist.",
});
    ...
    <PageTransition>
      <PageContainer>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">About Me</h1>
